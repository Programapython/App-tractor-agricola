...
from PySide6.QtWidgets import QApplication, QMainWindow, QVBoxLayout, QHBoxLayout,QPushButton, QWidget, QLabel, QDial, QFrame, QToolBar, QSplitter
...
class mainWindow(QMainWindow):
    ...
    def comLayout(self):
        ...
        # Layout columnas
        self.layoutColumnas = QSplitter(Qt.Horizontal)
        self.layout1.addWidget(self.layoutColumnas)
